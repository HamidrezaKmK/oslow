...
from baselines.codes.methods.lsnm.utils import TensorDataLoader
from sklearn.preprocessing import StandardScaler, SplineTransformer

from baselines.codes.methods.lsnm.hsic import HSIC
from baselines.codes.methods.lsnm.het_ridge import convex_fgls
from baselines.codes.methods.lsnm.ml import map_optimization
...
def het_fit_convex(x, y, n_steps=None):
    ...
    w_1, w_2, _, nll = convex_fgls(
        Phi_x, Phi_x.abs(), y, delta_Phi=1e-5, delta_Psi=1e-5, n_steps=n_steps
    )
