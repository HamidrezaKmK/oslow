# similar to the original implementation except for the following:
# line 78 used a inplace operation on a leaf variable, which is not allowed anymore
import numpy as np
...
class ProbabilisticDAG(nn.Module):
    def __init__(
        ...
        torch.diagonal(e).data = torch.ones_like(torch.diagonal(e)) * (-300)
